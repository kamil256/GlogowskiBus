function TimeTableContext(busStopsFromModel, busLinesFromModel)
{
    var self = this;
    ...
    self.busLines = new Collection();//BusLines();
    ...
    for (var i = 0; i < self.routes.count() ; i++)
        self.points.addMany(self.routes.getAt(i).points.toArray());
